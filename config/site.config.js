...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'liynw@mic.saiodgm.gq',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/cqbzljt/drive',
    },
    {
      name: 'Twitter',
      link: 'https://twitter.com/IvyLuo63131426',
    },
  ],
